...
public class NeuralWheelTrailRendererHandler : MonoBehaviour
{
    //Components
    NeuralCarController topDownCarController;
    ...
    void Awake()
    {
        ...
        topDownCarController = GetComponentInParent<NeuralCarController>();
